...
workbox.routing.registerRoute(new RegExp('/sat/_nuxt/'), new workbox.strategies.CacheFirst ({}), 'GET')
workbox.routing.registerRoute(new RegExp('/sat/'), new workbox.strategies.NetworkFirst ({}), 'GET')
